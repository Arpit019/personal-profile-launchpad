...
import { ArrowLeft, Terminal, Calendar, Folder } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 font-mono relative text-slate-300 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <motion.div 
          ...
          className="prose prose-invert prose-cyan max-w-none prose-headings:font-orbitron prose-headings:text-white prose-p:text-slate-300 prose-p:leading-relaxed prose-a:text-pink-400 prose-li:text-slate-300"
